...
## 5. Архитектура Пайплайна Восприятия (Perception System)
...
## 6. Гибридный Мозг (Decision System & Behavior Trees)
...
### 6.1. Узел вызова модели (LLM/CLIP)
...
### 6.2. Система Адаптеров для ИИ (AI Model Adapters)
...
#### 6.2.1. Единый Интерфейс (Base Adapter)
...
#### 6.2.2. Подготовка данных (Context Builder)
...
#### 6.2.4. Парсер Экшенов (Guardrails)
...
## 7. Исполнение Действий (Action Execution System)
...
### 8.1. Компоновка Рабочего Пространства (Workspace Layout)
...
### 8.2. Продвинутая Отладка (AAA-Level Features)

#### 8.2.1. Редактор Behavior Tree (Live Brain Editor)
...
#### 8.2.2. Инспекция и редактирование Буфера Данных (God Mode)
...
#### 8.2.3. Визуальные буферы и X-Ray Vision
...
### 8.3. Магия Авто-Интерфейса (Pydantic ➡️ DearPyGui)
...
### 8.4. Режим "Teacher" (Обучение с учителем)
...
### 8.5. Визуализация Data Extraction Pipeline (Web Parsing)
...
## 9. Внутренние Миры и Симуляция (Hybrid Environment)
...
### 9.1. Абстракция Среды (Environment Routing)
...
### 9.2. Прямое Восприятие (Direct Perception Bypass)
...
### 9.5. Мульти-Агентность и RL (Идеальный Спортзал)
